import { insert } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/BinarySearch.js'
import { ControlChange } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/ControlChange.js'
import { createControlChanges } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/ControlChanges.js'
import { PitchBend } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/PitchBend.js'
import { Header } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/Header.js'
import { Instrument } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/Instrument.js'
import { Note } from '/js/unilang-in-worker-environment/midi/lib/@tonejs/Note.js'
