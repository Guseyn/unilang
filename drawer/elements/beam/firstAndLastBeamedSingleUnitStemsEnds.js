...
const isProgressionOfCurrentBeamedSingleUnitsSupposedToHaveHorizontalBeamLine = require('./isProgressionOfCurrentBeamedSingleUnitsSupposedToHaveHorizontalBeamLine')

module.exports = (currentBeamedSingleUnits, anyStemDirectionChangesInBeamedSingleUnits, minTopInCurrentBeamedSingleUnits, maxBottomInCurrentBeamedSingleUnits, beamLineHeightNormal, allBeamsHeightNormalWhereAllStemsWithSameDirection, styles) => {
