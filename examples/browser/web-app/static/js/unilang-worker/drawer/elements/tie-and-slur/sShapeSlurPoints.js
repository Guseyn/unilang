...
import nextSlurDirectionBySingleUnit from '/js/unilang-worker/drawer/elements/tie-and-slur/nextSlurDirectionBySingleUnit.js'
import slurJunctionPointForSingleUnit from '/js/unilang-worker/drawer/elements/tie-and-slur/slurJunctionPointForSingleUnit.js'
...
import intersectionPointsForOnOnePartOfSShapeSlurWithItsSingleUnits from '/js/unilang-worker/drawer/elements/tie-and-slur/intersectionPointsForOnOnePartOfSShapeSlurWithItsSingleUnits.js'
import yOffsetForSShapeSlurSoThatItCanBeAboveOrUnderAllNotes from '/js/unilang-worker/drawer/elements/tie-and-slur/yOffsetForSShapeSlurSoThatItCanBeAboveOrUnderAllNotes.js'
import sShapeSlurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits from '/js/unilang-worker/drawer/elements/tie-and-slur/sShapeSlurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits.js'
import gluedSlurParts from '/js/unilang-worker/drawer/elements/tie-and-slur/gluedSlurParts.js'
import slurRoundCoefficientByXRangeOfSShapeSlur from '/js/unilang-worker/drawer/elements/tie-and-slur/slurRoundCoefficientByXRangeOfSShapeSlur.js'
