...
import parserScenarios from '/js/e-unilang/unilang-worker/language/parser/scenarios/parserScenarios.js'
import mapWithScenariosAndScenariosWhereItIsRequired from '/js/e-unilang/unilang-worker/language/parser/scenarios/mapWithScenariosAndScenariosWhereItIsRequired.js'
...
import withoutCommandDelimitersAsPartOfTokensAndConjunctionsBetweenThem from '/js/e-unilang/unilang-worker/language/parser/scenarios/token/withoutCommandDelimitersAsPartOfTokensAndConjunctionsBetweenThem.js'
import tokenValuesFromTokens from '/js/e-unilang/unilang-worker/language/parser/scenarios/token/tokenValuesFromTokens.js'
import joinedTokensWithRealDelimiters from '/js/e-unilang/unilang-worker/language/parser/scenarios/token/joinedTokensWithRealDelimiters.js'
