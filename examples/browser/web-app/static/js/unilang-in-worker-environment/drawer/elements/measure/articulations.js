...
import staccato from '/js/unilang-in-worker-environment/drawer/elements/articulation/staccato.js'
import spiccato from '/js/unilang-in-worker-environment/drawer/elements/articulation/spiccato.js'
import accent from '/js/unilang-in-worker-environment/drawer/elements/articulation/accent.js'
import tenuto from '/js/unilang-in-worker-environment/drawer/elements/articulation/tenuto.js'
import marcato from '/js/unilang-in-worker-environment/drawer/elements/articulation/marcato.js'
import fermata from '/js/unilang-in-worker-environment/drawer/elements/articulation/fermata.js'
import leftHandPizzicato from '/js/unilang-in-worker-environment/drawer/elements/articulation/leftHandPizzicato.js'
import snapPizzicato from '/js/unilang-in-worker-environment/drawer/elements/articulation/snapPizzicato.js'
import naturalHarmonic from '/js/unilang-in-worker-environment/drawer/elements/articulation/naturalHarmonic.js'
import upBow from '/js/unilang-in-worker-environment/drawer/elements/articulation/upBow.js'
import downBow from '/js/unilang-in-worker-environment/drawer/elements/articulation/downBow.js'
import turn from '/js/unilang-in-worker-environment/drawer/elements/articulation/turn.js'
import trill from '/js/unilang-in-worker-environment/drawer/elements/articulation/trill.js'
import mordent from '/js/unilang-in-worker-environment/drawer/elements/articulation/mordent.js'
import noteLetter from '/js/unilang-in-worker-environment/drawer/elements/articulation/noteLetter.js'
import dynamicMark from '/js/unilang-in-worker-environment/drawer/elements/articulation/dynamicMark.js'
import octaveSign from '/js/unilang-in-worker-environment/drawer/elements/articulation/octaveSign.js'
...
import scaleElementAroundPoint from '/js/unilang-in-worker-environment/drawer/elements/basic/scaleElementAroundPoint.js'
import addPropertiesToElement from '/js/unilang-in-worker-environment/drawer/elements/basic/addPropertiesToElement.js'
import topOfStaveForFirstNoteInCurrentSingleUnit from '/js/unilang-in-worker-environment/drawer/elements/stave/topOfStaveForFirstNoteInCurrentSingleUnit.js'
import topOfStaveForLastNoteInCurrentSingleUnit from '/js/unilang-in-worker-environment/drawer/elements/stave/topOfStaveForLastNoteInCurrentSingleUnit.js'
import articulationIsAttachedToUnit from '/js/unilang-in-worker-environment/drawer/elements/articulation/articulationIsAttachedToUnit.js'
import outlineForArticulation from '/js/unilang-in-worker-environment/drawer/elements/articulation/outlineForArticulation.js'
