import opentype from '/js/unilang-worker/drawer/lib/opentype/opentype.js'
import parsedUnilang from '/js/unilang-worker/language/parser/parsedUnilang.js'
import validatedPageSchema from '/js/unilang-worker/language/schema/validatedPageSchema.js'
import generatedStyles from '/js/unilang-worker/drawer/generatedStyles.js'
import svgAsString from '/js/unilang-worker/drawer/elements/basic/svgAsString.js'
import svg from '/js/unilang-worker/drawer/elements/basic/svg.js'
import page from '/js/unilang-worker/drawer/elements/page/page.js'
import midi from '/js/unilang-worker/midi/midi.js'
