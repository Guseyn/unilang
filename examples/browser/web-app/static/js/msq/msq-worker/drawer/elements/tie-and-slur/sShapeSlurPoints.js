...
import nextSlurDirectionBySingleUnit from '/js/msq/msq-worker/drawer/elements/tie-and-slur/nextSlurDirectionBySingleUnit.js'
import slurJunctionPointForSingleUnit from '/js/msq/msq-worker/drawer/elements/tie-and-slur/slurJunctionPointForSingleUnit.js'
...
import intersectionPointsForOnOnePartOfSShapeSlurWithItsSingleUnits from '/js/msq/msq-worker/drawer/elements/tie-and-slur/intersectionPointsForOnOnePartOfSShapeSlurWithItsSingleUnits.js'
import yOffsetForSShapeSlurSoThatItCanBeAboveOrUnderAllNotes from '/js/msq/msq-worker/drawer/elements/tie-and-slur/yOffsetForSShapeSlurSoThatItCanBeAboveOrUnderAllNotes.js'
import sShapeSlurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits from '/js/msq/msq-worker/drawer/elements/tie-and-slur/sShapeSlurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits.js'
import gluedSlurParts from '/js/msq/msq-worker/drawer/elements/tie-and-slur/gluedSlurParts.js'
import slurRoundCoefficientByXRangeOfSShapeSlur from '/js/msq/msq-worker/drawer/elements/tie-and-slur/slurRoundCoefficientByXRangeOfSShapeSlur.js'
