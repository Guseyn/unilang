...
import calculatedNumberOfBeamLinesByDuration from '/js/unilang-in-worker-environment/drawer/elements/beam/calculatedNumberOfBeamLinesByDuration.js'
import stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates from '/js/unilang-in-worker-environment/drawer/elements/unit/stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates.js'
import beams from '/js/unilang-in-worker-environment/drawer/elements/beam/beams.js'
import calculatedBeamLineCoefficients from '/js/unilang-in-worker-environment/drawer/elements/beam/calculatedBeamLineCoefficients.js'
import calculatedStemExtremePositionForDrawnBeamedSingleUnit from '/js/unilang-in-worker-environment/drawer/elements/beam/calculatedStemExtremePositionForDrawnBeamedSingleUnit.js'
import areAnyStemDirectionChangesInBeamedSingleUnits from '/js/unilang-in-worker-environment/drawer/elements/beam/areAnyStemDirectionChangesInBeamedSingleUnits.js'
import firstAndLastBeamedSingleUnitStemsEnds from '/js/unilang-in-worker-environment/drawer/elements/beam/firstAndLastBeamedSingleUnitStemsEnds.js'
