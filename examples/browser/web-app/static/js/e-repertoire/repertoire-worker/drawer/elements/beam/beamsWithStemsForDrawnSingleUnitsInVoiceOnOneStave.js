...
import calculatedNumberOfBeamLinesByDuration from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/calculatedNumberOfBeamLinesByDuration.js'
import stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates from '/js/e-repertoire/repertoire-worker/drawer/elements/unit/stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates.js'
import beams from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/beams.js'
import calculatedBeamLineCoefficients from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/calculatedBeamLineCoefficients.js'
import calculatedStemExtremePositionForDrawnBeamedSingleUnit from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/calculatedStemExtremePositionForDrawnBeamedSingleUnit.js'
import areAnyStemDirectionChangesInBeamedSingleUnits from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/areAnyStemDirectionChangesInBeamedSingleUnits.js'
import firstAndLastBeamedSingleUnitStemsEnds from '/js/e-repertoire/repertoire-worker/drawer/elements/beam/firstAndLastBeamedSingleUnitStemsEnds.js'
