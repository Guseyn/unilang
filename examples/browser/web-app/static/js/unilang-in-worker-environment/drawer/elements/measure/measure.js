...
import clefsOnStaves from '/js/unilang-in-worker-environment/drawer/elements/clef/clefsOnStaves.js'
import keySignaturesOnStaves from '/js/unilang-in-worker-environment/drawer/elements/key/keySignaturesOnStaves.js'
import timeSignaturesOnStaves from '/js/unilang-in-worker-environment/drawer/elements/time/timeSignaturesOnStaves.js'
import voicesOnMultipleStavesWithStavesPiece from '/js/unilang-in-worker-environment/drawer/elements/voice/voicesOnMultipleStavesWithStavesPiece.js'
import multiMeasureRest from '/js/unilang-in-worker-environment/drawer/elements/rest/multiMeasureRest.js'
import similePreviousMeasure from '/js/unilang-in-worker-environment/drawer/elements/simile/similePreviousMeasure.js'
import simileTwoPreviousMeasure from '/js/unilang-in-worker-environment/drawer/elements/simile/simileTwoPreviousMeasure.js'
import barLine from '/js/unilang-in-worker-environment/drawer/elements/line/barLine.js'
import boldDoubleBarLine from '/js/unilang-in-worker-environment/drawer/elements/line/boldDoubleBarLine.js'
import dottedBarLine from '/js/unilang-in-worker-environment/drawer/elements/line/dottedBarLine.js'
import doubleBarLine from '/js/unilang-in-worker-environment/drawer/elements/line/doubleBarLine.js'
import startBarLine from '/js/unilang-in-worker-environment/drawer/elements/line/startBarLine.js'
import startBoldDoubleBarLine from '/js/unilang-in-worker-environment/drawer/elements/line/startBoldDoubleBarLine.js'
import measureNumber from '/js/unilang-in-worker-environment/drawer/elements/measure/measureNumber.js'
import repeatDots from '/js/unilang-in-worker-environment/drawer/elements/measure/repeatDots.js'
import combinedConnections from '/js/unilang-in-worker-environment/drawer/elements/connection/combinedConnections.js'
import combinedInstrumentTitles from '/js/unilang-in-worker-environment/drawer/elements/connection/combinedInstrumentTitles.js'
