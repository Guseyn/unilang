...
import slurSplinePoints from '/js/unilang-worker/drawer/elements/tie-and-slur/slurSplinePoints.js'
import slurJunctionPhantomPoint from '/js/unilang-worker/drawer/elements/tie-and-slur/slurJunctionPhantomPoint.js'
import slurRoundCoefficientByXRangeOfSlur from '/js/unilang-worker/drawer/elements/tie-and-slur/slurRoundCoefficientByXRangeOfSlur.js'
import intersectionPointsOfSlurWithItsSingleUnits from '/js/unilang-worker/drawer/elements/tie-and-slur/intersectionPointsOfSlurWithItsSingleUnits.js'
import twoIntersectionPointsInFirstAndSecondHalfsOfSlurWhereSlurCreatesBiggestGapsWithSingleUnitTopOrBottomPositionsInEachHalfRespectivelyDependingOnSlurDirection from '/js/unilang-worker/drawer/elements/tie-and-slur/twoIntersectionPointsInFirstAndSecondHalfsOfSlurWhereSlurCreatesBiggestGapsWithSingleUnitTopOrBottomPositionsInEachHalfRespectivelyDependingOnSlurDirection.js'
import stretchedSlurSplineSoItCannotIntersectItsSingleUnitsExceptMaybeSomeUnitAtTheStartAndAtTheEndToAvoidBigStretching from '/js/unilang-worker/drawer/elements/tie-and-slur/stretchedSlurSplineSoItCannotIntersectItsSingleUnitsExceptMaybeSomeUnitAtTheStartAndAtTheEndToAvoidBigStretching.js'
import additionalPathPointsForSlurToMakeItBulk from '/js/unilang-worker/drawer/elements/tie-and-slur/additionalPathPointsForSlurToMakeItBulk.js'
import yOffsetForSlurSoThatItCanBeAboveOrUnderAllNotes from '/js/unilang-worker/drawer/elements/tie-and-slur/yOffsetForSlurSoThatItCanBeAboveOrUnderAllNotes.js'
import slurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits from '/js/unilang-worker/drawer/elements/tie-and-slur/slurSplinePointsWithAdjustedYOffsetSoItCannotIntersectUnits.js'
