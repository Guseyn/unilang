...
import parserScenarios from '/js/msq/worker/language/parser/scenarios/parserScenarios.js'
import mapWithScenariosAndScenariosWhereItIsRequired from '/js/msq/worker/language/parser/scenarios/mapWithScenariosAndScenariosWhereItIsRequired.js'
...
import withoutCommandDelimitersAsPartOfTokensAndConjunctionsBetweenThem from '/js/msq/worker/language/parser/scenarios/token/withoutCommandDelimitersAsPartOfTokensAndConjunctionsBetweenThem.js'
import tokenValuesFromTokens from '/js/msq/worker/language/parser/scenarios/token/tokenValuesFromTokens.js'
import joinedTokensWithRealDelimiters from '/js/msq/worker/language/parser/scenarios/token/joinedTokensWithRealDelimiters.js'
