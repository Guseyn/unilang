...
import treble from '/js/unilang-worker/drawer/elements/clef/trebleClef.js'
import bass from '/js/unilang-worker/drawer/elements/clef/bassClef.js'
import alto from '/js/unilang-worker/drawer/elements/clef/altoClef.js'
import baritone from '/js/unilang-worker/drawer/elements/clef/baritoneClef.js'
import mezzoSoprano from '/js/unilang-worker/drawer/elements/clef/mezzoSopranoClef.js'
import octaveEightUp from '/js/unilang-worker/drawer/elements/clef/octaveEightUpClef.js'
import octaveEightDown from '/js/unilang-worker/drawer/elements/clef/octaveEightDownClef.js'
import octaveFifteenUp from '/js/unilang-worker/drawer/elements/clef/octaveFifteenUpClef.js'
import octaveFifteenDown from '/js/unilang-worker/drawer/elements/clef/octaveFifteenDownClef.js'
import soprano from '/js/unilang-worker/drawer/elements/clef/sopranoClef.js'
import tenor from '/js/unilang-worker/drawer/elements/clef/tenorClef.js'
