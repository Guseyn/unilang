...
import configurableStyleNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/configurableStyleNames.js'
import pageMetaNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/pageMetaNames.js'
import openingBarLineNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/openingBarLineNames.js'
import closingBarLineNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/closingBarLineNames.js'
import applicationOfMeasureNumbersNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/applicationOfMeasureNumbersNames.js'
import keySignatureNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/keySignatureNames.js'
import tempoDurationPartNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/tempoDurationPartNames.js'
import clefNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/clefNames.js'
import noteDurationNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/noteDurationNames.js'
import noteNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/noteNames.js'
import stavePositionNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/stavePositionNames.js'
import noteKeyNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/noteKeyNames.js'
import breathMarkNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/breathMarkNames.js'
import articulationNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/articulationNames.js'
import ornamentKeyNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/ornamentKeyNames.js'
import midiSettingNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/midiSettingNames.js'
import instrumentNames from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/instrumentNames.js'
import withoutDoubleSpacesAndTrimmed from '/js/e-msq/msq-worker/language/parser/scenarios/token/withoutDoubleSpacesAndTrimmed.js'
...
import cssColors from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/cssColors.js'
