import opentype from '/js/unilang-in-worker-environment/drawer/lib/opentype/opentype.js'
import parsedUnilang from '/js/unilang-in-worker-environment/language/parser/parsedUnilang.js'
import validatedPageSchema from '/js/unilang-in-worker-environment/language/schema/validatedPageSchema.js'
import generatedStyles from '/js/unilang-in-worker-environment/drawer/generatedStyles.js'
import svgAsString from '/js/unilang-in-worker-environment/drawer/elements/basic/svgAsString.js'
import svg from '/js/unilang-in-worker-environment/drawer/elements/basic/svg.js'
import page from '/js/unilang-in-worker-environment/drawer/elements/page/page.js'
import midi from '/js/unilang-in-worker-environment/midi/midi.js'
