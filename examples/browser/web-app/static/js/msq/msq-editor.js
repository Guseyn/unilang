...
class MuSemantiQEditor extends HTMLTemplateElement {
  constructor() {
    super()
  ...
  async #render() {
    ...
    const messageHandler = (event) => {
      ...
      const highlightsHtmlBuffer = event.data.highlightsHtmlBuffer
      const errors = event.data.errors
      const mapWithScenariosAndScenariosWhereItIsRequired = event.data.mapWithScenariosAndScenariosWhereItIsRequired
  ...
  #buildView({
    ...
    elm.shadowRoot.innerHTML = /*html*/`
      ...
      <div data-inner-wrapper>
        ...
        <div data-msq-container data-scroll>
          <textarea></textarea>
        </div>
        <midi-player
    ...
    const readMSQButton = elm.shadowRoot.querySelector('button[data-read-msq]')
