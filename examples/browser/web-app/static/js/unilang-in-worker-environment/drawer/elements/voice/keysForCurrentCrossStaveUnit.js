...
import sortedKeysForSingleUnitConsideringStaves from '/js/unilang-in-worker-environment/drawer/elements/unit/sortedKeysForSingleUnitConsideringStaves.js'
import doubleFlatKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/doubleFlatKeyShape.js'
import doubleSharpKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/doubleSharpKeyShape.js'
import flatKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/flatKeyShape.js'
import naturalKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/naturalKeyShape.js'
import sharpKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/sharpKeyShape.js'
import demiflatKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/demiflatKeyShape.js'
import sesquiflatKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/sesquiflatKeyShape.js'
import demisharpKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/demisharpKeyShape.js'
import sesquisharpKeyShape from '/js/unilang-in-worker-environment/drawer/elements/key/sesquisharpKeyShape.js'
import noteLetterShape from '/js/unilang-in-worker-environment/drawer/elements/key/noteLetterShape.js'
import parenthesesSpline from '/js/unilang-in-worker-environment/drawer/elements/bracket/parenthesesSpline.js'
const keysTypes = {
