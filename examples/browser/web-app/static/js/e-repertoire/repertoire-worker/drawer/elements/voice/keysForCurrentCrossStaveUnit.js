...
import sortedKeysForSingleUnitConsideringStaves from '/js/e-repertoire/repertoire-worker/drawer/elements/unit/sortedKeysForSingleUnitConsideringStaves.js'
import doubleFlatKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/doubleFlatKeyShape.js'
import doubleSharpKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/doubleSharpKeyShape.js'
import flatKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/flatKeyShape.js'
import naturalKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/naturalKeyShape.js'
...
import sesquiflatKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/sesquiflatKeyShape.js'
import demisharpKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/demisharpKeyShape.js'
import sesquisharpKeyShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/sesquisharpKeyShape.js'
import noteLetterShape from '/js/e-repertoire/repertoire-worker/drawer/elements/key/noteLetterShape.js'
import parenthesesSpline from '/js/e-repertoire/repertoire-worker/drawer/elements/bracket/parenthesesSpline.js'
const keysTypes = {
