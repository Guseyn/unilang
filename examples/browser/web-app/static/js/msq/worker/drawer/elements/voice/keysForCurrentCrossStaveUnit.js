...
import sortedKeysForSingleUnitConsideringStaves from '/js/msq/worker/drawer/elements/unit/sortedKeysForSingleUnitConsideringStaves.js'
import doubleFlatKeyShape from '/js/msq/worker/drawer/elements/key/doubleFlatKeyShape.js'
import doubleSharpKeyShape from '/js/msq/worker/drawer/elements/key/doubleSharpKeyShape.js'
import flatKeyShape from '/js/msq/worker/drawer/elements/key/flatKeyShape.js'
import naturalKeyShape from '/js/msq/worker/drawer/elements/key/naturalKeyShape.js'
import sharpKeyShape from '/js/msq/worker/drawer/elements/key/sharpKeyShape.js'
import demiflatKeyShape from '/js/msq/worker/drawer/elements/key/demiflatKeyShape.js'
import sesquiflatKeyShape from '/js/msq/worker/drawer/elements/key/sesquiflatKeyShape.js'
import demisharpKeyShape from '/js/msq/worker/drawer/elements/key/demisharpKeyShape.js'
import sesquisharpKeyShape from '/js/msq/worker/drawer/elements/key/sesquisharpKeyShape.js'
import noteLetterShape from '/js/msq/worker/drawer/elements/key/noteLetterShape.js'
import parenthesesSpline from '/js/msq/worker/drawer/elements/bracket/parenthesesSpline.js'
const keysTypes = {
