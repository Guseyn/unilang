...
import sortedKeysForSingleUnitConsideringStaves from '/js/e-msq/msq-worker/drawer/elements/unit/sortedKeysForSingleUnitConsideringStaves.js'
import doubleFlatKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/doubleFlatKeyShape.js'
import doubleSharpKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/doubleSharpKeyShape.js'
import flatKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/flatKeyShape.js'
import naturalKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/naturalKeyShape.js'
import sharpKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/sharpKeyShape.js'
import demiflatKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/demiflatKeyShape.js'
import sesquiflatKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/sesquiflatKeyShape.js'
import demisharpKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/demisharpKeyShape.js'
import sesquisharpKeyShape from '/js/e-msq/msq-worker/drawer/elements/key/sesquisharpKeyShape.js'
import noteLetterShape from '/js/e-msq/msq-worker/drawer/elements/key/noteLetterShape.js'
import parenthesesSpline from '/js/e-msq/msq-worker/drawer/elements/bracket/parenthesesSpline.js'
const keysTypes = {
