...
import calculatedNumberOfBeamLinesByDuration from '/js/unilang-worker/drawer/elements/beam/calculatedNumberOfBeamLinesByDuration.js'
import stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates from '/js/unilang-worker/drawer/elements/unit/stemForSingleUnitInBeamedPartOfVoiceByStemPlaceholderCoordinates.js'
import beams from '/js/unilang-worker/drawer/elements/beam/beams.js'
import calculatedBeamLineCoefficients from '/js/unilang-worker/drawer/elements/beam/calculatedBeamLineCoefficients.js'
import calculatedStemExtremePositionForDrawnBeamedSingleUnit from '/js/unilang-worker/drawer/elements/beam/calculatedStemExtremePositionForDrawnBeamedSingleUnit.js'
import areAnyStemDirectionChangesInBeamedSingleUnits from '/js/unilang-worker/drawer/elements/beam/areAnyStemDirectionChangesInBeamedSingleUnits.js'
import firstAndLastBeamedSingleUnitStemsEnds from '/js/unilang-worker/drawer/elements/beam/firstAndLastBeamedSingleUnitStemsEnds.js'
