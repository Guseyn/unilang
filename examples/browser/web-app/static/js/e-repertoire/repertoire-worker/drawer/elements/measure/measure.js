...
import clefsOnStaves from '/js/e-repertoire/repertoire-worker/drawer/elements/clef/clefsOnStaves.js'
import keySignaturesOnStaves from '/js/e-repertoire/repertoire-worker/drawer/elements/key/keySignaturesOnStaves.js'
import timeSignaturesOnStaves from '/js/e-repertoire/repertoire-worker/drawer/elements/time/timeSignaturesOnStaves.js'
import voicesOnMultipleStavesWithStavesPiece from '/js/e-repertoire/repertoire-worker/drawer/elements/voice/voicesOnMultipleStavesWithStavesPiece.js'
import multiMeasureRest from '/js/e-repertoire/repertoire-worker/drawer/elements/rest/multiMeasureRest.js'
import similePreviousMeasure from '/js/e-repertoire/repertoire-worker/drawer/elements/simile/similePreviousMeasure.js'
import simileTwoPreviousMeasure from '/js/e-repertoire/repertoire-worker/drawer/elements/simile/simileTwoPreviousMeasure.js'
import barLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/barLine.js'
import boldDoubleBarLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/boldDoubleBarLine.js'
import dottedBarLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/dottedBarLine.js'
import doubleBarLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/doubleBarLine.js'
import startBarLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/startBarLine.js'
import startBoldDoubleBarLine from '/js/e-repertoire/repertoire-worker/drawer/elements/line/startBoldDoubleBarLine.js'
import measureNumber from '/js/e-repertoire/repertoire-worker/drawer/elements/measure/measureNumber.js'
import repeatDots from '/js/e-repertoire/repertoire-worker/drawer/elements/measure/repeatDots.js'
import combinedConnections from '/js/e-repertoire/repertoire-worker/drawer/elements/connection/combinedConnections.js'
import combinedInstrumentTitles from '/js/e-repertoire/repertoire-worker/drawer/elements/connection/combinedInstrumentTitles.js'
