...
import staccato from '/js/msq/msq-worker/drawer/elements/articulation/staccato.js'
import spiccato from '/js/msq/msq-worker/drawer/elements/articulation/spiccato.js'
import accent from '/js/msq/msq-worker/drawer/elements/articulation/accent.js'
import tenuto from '/js/msq/msq-worker/drawer/elements/articulation/tenuto.js'
import marcato from '/js/msq/msq-worker/drawer/elements/articulation/marcato.js'
import fermata from '/js/msq/msq-worker/drawer/elements/articulation/fermata.js'
import leftHandPizzicato from '/js/msq/msq-worker/drawer/elements/articulation/leftHandPizzicato.js'
import snapPizzicato from '/js/msq/msq-worker/drawer/elements/articulation/snapPizzicato.js'
import naturalHarmonic from '/js/msq/msq-worker/drawer/elements/articulation/naturalHarmonic.js'
import upBow from '/js/msq/msq-worker/drawer/elements/articulation/upBow.js'
import downBow from '/js/msq/msq-worker/drawer/elements/articulation/downBow.js'
import turn from '/js/msq/msq-worker/drawer/elements/articulation/turn.js'
import trill from '/js/msq/msq-worker/drawer/elements/articulation/trill.js'
import mordent from '/js/msq/msq-worker/drawer/elements/articulation/mordent.js'
import noteLetter from '/js/msq/msq-worker/drawer/elements/articulation/noteLetter.js'
import dynamicMark from '/js/msq/msq-worker/drawer/elements/articulation/dynamicMark.js'
import octaveSign from '/js/msq/msq-worker/drawer/elements/articulation/octaveSign.js'
...
import topOfStaveForFirstNoteInCurrentSingleUnit from '/js/msq/msq-worker/drawer/elements/stave/topOfStaveForFirstNoteInCurrentSingleUnit.js'
import topOfStaveForLastNoteInCurrentSingleUnit from '/js/msq/msq-worker/drawer/elements/stave/topOfStaveForLastNoteInCurrentSingleUnit.js'
import articulationIsAttachedToUnit from '/js/msq/msq-worker/drawer/elements/articulation/articulationIsAttachedToUnit.js'
import outlineForArticulation from '/js/msq/msq-worker/drawer/elements/articulation/outlineForArticulation.js'
