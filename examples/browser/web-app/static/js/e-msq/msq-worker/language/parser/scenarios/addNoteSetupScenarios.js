...
import foundNextTokenValueOnTheLine from '/js/e-msq/msq-worker/language/parser/scenarios/token/foundNextTokenValueOnTheLine.js'
import foundNextTokenValuesOnTheLine from '/js/e-msq/msq-worker/language/parser/scenarios/token/foundNextTokenValuesOnTheLine.js'
import withNumbersInsteadOfWords from '/js/e-msq/msq-worker/language/parser/scenarios/token/withNumbersInsteadOfWords.js'
import isVerticalCorrection from '/js/e-msq/msq-worker/language/parser/scenarios/token/isVerticalCorrection.js'
import verticalCorrection from '/js/e-msq/msq-worker/language/parser/scenarios/token/verticalCorrection.js'
import isHorizontalCorrection from '/js/e-msq/msq-worker/language/parser/scenarios/token/isHorizontalCorrection.js'
import horizontalCorrection from '/js/e-msq/msq-worker/language/parser/scenarios/token/horizontalCorrection.js'
import isDirection from '/js/e-msq/msq-worker/language/parser/scenarios/token/isDirection.js'
import isStaveIndex from '/js/e-msq/msq-worker/language/parser/scenarios/token/isStaveIndex.js'
import direction from '/js/e-msq/msq-worker/language/parser/scenarios/token/direction.js'
import staveIndexByTokens from '/js/e-msq/msq-worker/language/parser/scenarios/token/staveIndexByTokens.js'
import isRoundness from '/js/e-msq/msq-worker/language/parser/scenarios/token/isRoundness.js'
import roundness from '/js/e-msq/msq-worker/language/parser/scenarios/token/roundness.js'
import isAboveBelowOverUnderStaveLines from '/js/e-msq/msq-worker/language/parser/scenarios/token/isAboveBelowOverUnderStaveLines.js'
import isAboveBelowOverUnder from '/js/e-msq/msq-worker/language/parser/scenarios/token/isAboveBelowOverUnder.js'
import directionByAboveBelowOverUnderStaveLines from '/js/e-msq/msq-worker/language/parser/scenarios/token/directionByAboveBelowOverUnderStaveLines.js'
import directionByAboveBelowOverUnder from '/js/e-msq/msq-worker/language/parser/scenarios/token/directionByAboveBelowOverUnder.js'
import isMeasureNumber from '/js/e-msq/msq-worker/language/parser/scenarios/token/isMeasureNumber.js'
import measureNumber from '/js/e-msq/msq-worker/language/parser/scenarios/token/measureNumber.js'
import isNumberOfStrokes from '/js/e-msq/msq-worker/language/parser/scenarios/token/isNumberOfStrokes.js'
import numberOfStrokes from '/js/e-msq/msq-worker/language/parser/scenarios/token/numberOfStrokes.js'
import isNumberOfTimes from '/js/e-msq/msq-worker/language/parser/scenarios/token/isNumberOfTimes.js'
import numberOfTimes from '/js/e-msq/msq-worker/language/parser/scenarios/token/numberOfTimes.js'
import restPositionNumberByRestPositionName from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/restPositionNumberByRestPositionName.js'
import initNewMeasureParamsIfThereIsAlreadySuchMeasurePropertyOrNoMeasuresAtAll from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/initNewMeasureParamsIfThereIsAlreadySuchMeasurePropertyOrNoMeasuresAtAll.js'
import initNewStaveParamsIfThereIsAlreadySuchStavePropertyOrNoStavesAtAll from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/initNewStaveParamsIfThereIsAlreadySuchStavePropertyOrNoStavesAtAll.js'
import initNewVoiceParamsIfThereIsNoVoicesAtAllAndInitNewChordParamsIfThereIsAlreadySuchChordProperty from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/initNewVoiceParamsIfThereIsNoVoicesAtAllAndInitNewChordParamsIfThereIsAlreadySuchChordProperty.js'
import lastMeasureParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastMeasureParams.js'
import lastStaveParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastStaveParams.js'
import lastVoiceParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastVoiceParams.js'
import lastNonSimileChordParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastNonSimileChordParams.js'
import lastNoteParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastNoteParams.js'
import lastKeyParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastKeyParams.js'
import lastArticulationParams from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastArticulationParams.js'
import lastGlissandoMark from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastGlissandoMark.js'
import lastLyric from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/lastLyric.js'
import keySignatureThatUserMeant from '/js/e-msq/msq-worker/language/parser/scenarios/page-schema/keySignatureThatUserMeant.js'
import noteDurations from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/noteDurations.js'
import stavePositions from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/stavePositions.js'
import noteKeys from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/noteKeys.js'
import breathMarks from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/breathMarks.js'
import clefs from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/clefs.js'
import articulations from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/articulations.js'
import ornamentKeys from '/js/e-msq/msq-worker/language/parser/scenarios/static-objects/ornamentKeys.js'
import theSameScenarioButWithDifferentRequiredCommandProgression from '/js/e-msq/msq-worker/language/parser/scenarios/theSameScenarioButWithDifferentRequiredCommandProgression.js'
